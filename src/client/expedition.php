    ...
    <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Liste de vos expeditions :</h4>
                                    ...
                                    <table class="table user-table no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Numero de suivi</th>
                                                <th class="border-top-0">Date Expedition</th>
                                                <th class="border-top-0">Statut</th>
                                                <th class="border-top-0">Infos</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php
